...
<div class="row">
    <div class="col-md-6">
        ...
        <a href="{{ route('games.dino') }}" class="card" style="height: 370px; cursor:pointer; background-image: url('{{ asset('storage/dashboard/maxresdefault.jpg') }}'); background-size: cover; background-position: top;">
            <div class="card-body">
