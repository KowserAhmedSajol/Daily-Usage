                            ...
                            <div class="col-md-3">
                                <div class="form-group form-group-float">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Add Remark">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 text-center">
                                <button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left legitRipple"><b><i class="icon-plus3"></i></b> Add</button>
                            </div>
                        </div>
							...
							<table class="table table-bordered">
								...
								<tbody>
									<tr>
										...
										<td class="text-center">Bus Vara</td>
										<td class="text-center">30</td>
										<td class="text-center">Bus Fare</td>
										<td class="text-center">15/05/2024</td>
										<td class="text-center"></td>
									</tr>
									<tr>
										<td class="text-center">2</td>
										<td class="text-center">Khabar</td>
									...
									<tr>
										...
										<td class="text-center">Auto Vara</td>
										<td class="text-center">15</td>
										<td class="text-center">Auto Fare</td>
										<td class="text-center">15/05/2024</td>
										<td class="text-center"></td>
									</tr>
									<tr>
